...
optimizer = torch.optim.SGD(model.regression_head.parameters(), lr=0.001, momentum=0.9, weight_decay=0.0005)

criterion = Yolo_Loss()
scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[60], gamma=10)
