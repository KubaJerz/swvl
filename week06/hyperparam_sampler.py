...
HYPERPARAM_OPTIONS = {
    "lr": [1e-3, 1e-4],
    "dropout": [0.3, 0.4, 0.5, 0.6, 0.65],
    "weight_decay": [0, 0, 0.01, 0.001, 0.0005]
}
...
full_dataset = FullFaceDatasetOptimized(TRAIN_CSV_PATH, TRAIN_IMG_DIR, TRAIN_LABELS_DIR, transforms=transform_img_net, target_size=(448, 448))
